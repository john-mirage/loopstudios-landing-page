  ...
  return (
    <section className="relative flex w-full h-650">
      ...
      <div className="relative z-30 container m-auto px-24">
        <h2 className="w-full px-28 py-24 text-h2 font-light text-white uppercase border-white border-2 lg:w-650 lg:text-h2-lg">immersive<br/>experiences<br/>that<br/>deliver</h2>
      </div>
