...
function Footer() {
  return (
    <footer className="w-full h-auto bg-black py-48">
      <div className="container mx-auto px-24 text-center text-white lg:h-120 lg:flex lg:flex-row lg:items-center lg:flex-wrap">
        ...
        <div className="mb-40 lg:order-3 lg:w-1/2 lg:mb-0">
          <MainNavigation drawer={false} label="main navigation for the footer" />
        </div>
        <SocialNavigation />
